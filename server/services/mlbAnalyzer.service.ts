...
export class MLBAnalyzerService {
    ...
    private scoreTitleSEO(productData: MLBAnalysisData): number {
        ...
        const categoryName = this.extractCategoryKeywords(productData.category_id);
    ...
    private scoreKeywordsDensity(productData: MLBAnalysisData): number {
        ...
        const categoryKeywords = this.extractCategoryKeywords(productData.category_id);
     ...
     */
    private extractCategoryKeywords(categoryId: string): string[] {
        // Mapeamento básico de categorias para palavras-chave
        const categoryMappings: { [key: string]: string[] } = {
            'MLB1276': ['fone', 'headphone', 'audio', 'som'],
            'MLB1051': ['celular', 'smartphone', 'mobile', 'telefone'],
            'MLB1652': ['notebook', 'laptop', 'computador'],
            'MLB1432': ['brinco', 'joia', 'bijuteria', 'acessório'],
