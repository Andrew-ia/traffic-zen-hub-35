...
add_env "VITE_API_URL" "$VITE_API_URL"
...
add_env "GA4_SERVICE_ACCOUNT_KEY" "$GA4_SERVICE_ACCOUNT_KEY"
...
# Mercado Livre
add_env "MERCADO_LIVRE_CLIENT_ID" "$MERCADO_LIVRE_CLIENT_ID"
add_env "MERCADO_LIVRE_CLIENT_SECRET" "$MERCADO_LIVRE_CLIENT_SECRET"
add_env "MERCADO_LIVRE_ACCESS_TOKEN" "$MERCADO_LIVRE_ACCESS_TOKEN"
add_env "MERCADO_LIVRE_REFRESH_TOKEN" "$MERCADO_LIVRE_REFRESH_TOKEN"
add_env "MERCADO_LIVRE_USER_ID" "$MERCADO_LIVRE_USER_ID"
