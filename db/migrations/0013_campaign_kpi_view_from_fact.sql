-- 0013_campaign_kpi_view_from_fact.sql
-- Atualiza v_campaign_kpi para buscar dados de fact_ads_daily ao invés de performance_metrics
...
SELECT
  ...
  f.campaign_id::uuid AS campaign_id,
  f.adset_id::uuid AS ad_set_id,
  f.ad_id::uuid AS ad_id,
