...
export const mainNavigation: NavigationEntry[] = [
  {
    ...
    children: [
      ...
      { name: "Pesquisa de Mercado", href: "/mercado-livre/pesquisa-mercado", icon: Search, keywords: ["pesquisa", "mercado", "concorrencia", "trends", "sourcing", "revenda"] },
      { name: "Sourcing de Catálogo", href: "/mercado-livre/sourcing-catalogo", icon: Search, keywords: ["catalogo", "fornecedor", "sourcing", "full", "compra", "revenda", "margem"] },
